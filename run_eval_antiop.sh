#!/usr/bin/env bash
# run_eval_antiop.sh - Merge sft-antiop LoRA checkpoint then run MATH-500 evaluation.
set -euo pipefail

WORK_DIR="/scratch/cvlab/home/shuli/agentic-research/ASFT"
BASE_MODEL="${WORK_DIR}/models/Qwen2.5-7B"
LORA_CKPT="${WORK_DIR}/output/sft-antiop-qwen2.5-7b"
MERGED_MODEL="${WORK_DIR}/output/sft-antiop-qwen2.5-7b-merged"
EVAL_OUTPUT="${WORK_DIR}/output/sft-antiop-qwen2.5-7b-matheval"

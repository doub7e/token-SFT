#!/usr/bin/env bash
# run_eval_paper.sh - Merge 7B LoRA checkpoint then run MATH-500 evaluation.
set -euo pipefail

WORK_DIR="/scratch/cvlab/home/shuli/agentic-research/ASFT"
BASE_MODEL="${WORK_DIR}/models/Qwen2.5-7B"
LORA_CKPT="${WORK_DIR}/output/asft-qwen2.5-7b-paper"
MERGED_MODEL="${WORK_DIR}/output/asft-qwen2.5-7b-paper-merged"
EVAL_OUTPUT="${WORK_DIR}/output/asft-qwen2.5-7b-paper-matheval"

...
# ── 3. Train ───────────────────────────────────────────────────────────────
echo "==> Starting sft-topk training (Qwen2.5-7B, LoRA r=32, keep_ratio=0.7)..."
python train_v2.py \
